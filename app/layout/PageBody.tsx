...
const PageBody: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div style={{ height: '90vh' }} className=" bg-white-500">
          
          <div className="flex flex-col items-center h-screen mt-40">
            {/* Welcome Message */}
            <h1 className="text-7xl font-bold text-center font-helvetica mb-8">Write, plan, share.<br /> All in one place.</h1>
            ...
            {/* Notion Image */}
            <div className="mt-5">    
            <img src={notion} style={{ width: '655px', height: '309px' }} alt="Notion" />
            </div>
          </div>
      </div>
      ...
      <div className=" bg-black">
        ...
        <div>
          <h2 className="text-7xl font-bold pt-10 pl-40 text-white">How it works</h2>
          <div className="px-20">
            <hr className="mt-6" />
          </div>
          ...
          <div className="flex flex-row justify-between mt-20 text-white">
            ...
            <div className="text-xl font-bold flex bg-white text-black p-2 rounded absolute mt-8 ml-40"
              style={{
            ...
            <div className="text-3xl flex font-medium flex ml-40 mt-24">
            Our approach to Organizing ideas
            </div>

                  {/* Paragraph */}
            <p className="text-xl mt-10 ml-40" >
            Efficient. Effective. Revolutionary. Your one and only<br/>
            platform to dynamic people and task management.<br/>
            <br/>
            Arrange your tasks and responsibilities with the aid of <br/>
            TasKing. Increase productivity and limit human errors <br/>
            with systematic automation.<br/>
            <br/> 
            ...
            <img src={image1} style={{ width: '663px', height: '472px' }} alt="Demo" />
            </div>
        ...
        <div className="flex flex-row items-center justify-between text-white">
          ...
          <div className="pl-40 mt-24">
            <img src={image2} style={{ width: '667px', height: '473px' }} alt ="Demo" />
          </div>
          ...
          <div>
            ...
            <div className="text-xl font-bold bg-white text-black p-2 rounded absolute mr-40"
                style={{
                    boxShadow: '0 0 6px white, 0 0 12px white, 0 0 18px white',
                    animation: 'neonGlow 1.5s infinite',
                }}>
            ...
            <div className="text-3xl flex font-medium flex mr-40 mt-20">
            ...
            <p className="text-xl">
              ...
              <br/>
              -Develop a detailed project plan with milestones and timelines. <br/>
              <br/>
        ...
        <div className="text-center mt-20 mb-10 text-7xl font-bold">
          Highlight
            ...
            {[icon1, icon2, icon3].map((icon, index) => (
              ...
              >
                <img src={icon} alt={`Icon ${index + 1}`} className="w-20 h-20" />
              </button>
            ))}
          </div>
