          ...
          {filteredProjects.map(project => (
            <button
              className={
                ...
                ' hover:border-[4px] shadow shadow-black hover:ease-out hover:duration-100 hover:bg-neutral-200 hover:scale-105 '
              }
          ...
          <AddProjectPopUp setTrigger={setPopup} trigger={Popup}>
            <div className="grid grid-cols-2 border-none">
              <div className="bg-white w-[320px] h-[480px] rounded-tl-[20px] rounded-bl-[20px] flex flex-col border-none">
                ...
                <button
                  className=" flex items-center justify-center w-[10rem] h-[10rem] bg-white text-black border-4 rounded-[20px] text-[60px]
                 mt-[4.12rem] ml-[5rem] border-black font-medium hover:ease-out hover:duration-300 pb-3 hover:scale-105"
                  onClick={() => {
                    handleCreateProject();
                    setPopup(false);
                  }}
